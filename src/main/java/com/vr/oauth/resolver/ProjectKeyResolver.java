...
/**
 * This is implementation of custom arguments which can be part of controller
 * methods. This feature can be used to create metadata from request data. This
 * can be helpful to check resource or entity level user access. For e.g. data
 * of one organization should not be available to users of other organizations.
 */
public class ProjectKeyResolver implements HandlerMethodArgumentResolver {
	...
	protected void throwMissingParameterException(String paramName, Class paramType) throws Exception {
