...
public class UserController extends BaseController {
	...
	@ApiOperation(value = "Create an user.", notes = "API to create new user.", response = User.class)
	...
	@ApiOperation(value = "Fetch user by id.", notes = "API to fetch user by id.", response = User.class)
